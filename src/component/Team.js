        ...
        <div className="grid gap-12 items-center md:grid-cols-3">
          <div className="space-y-4 text-center">
            <img
              ...
              src="https://tailus.io/sources/blocks/classNameic/preview/images/woman1.jpg"
              alt="woman"
              loading="lazy"
              width="640"
              height="805"
          ...
          <div className="space-y-4 text-center">
            <img
              ...
              src="https://tailus.io/sources/blocks/classNameic/preview/images/man.jpg"
              alt="man"
              loading="lazy"
              width="1000"
              height="667"
          ...
          <div className="space-y-4 text-center">
            <img
              className="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
              src="https://tailus.io/sources/blocks/classNameic/preview/images/woman.jpg"
              alt="woman"
              loading="lazy"
              width="1000"
              height="667"
